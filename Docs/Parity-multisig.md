...
> _"Полгаю, что проблему можно было бы легко избежать, если бы Parity убрала функцию `kill` при публикации смарт-контракта. Она полезна лишь на момент тестирования контракта, но никак не в целевой системе."_ - Дмитрий Б., архитектор ПО компании АйТи Сфера
